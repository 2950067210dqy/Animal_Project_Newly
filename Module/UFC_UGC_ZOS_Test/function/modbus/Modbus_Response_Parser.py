...
class Modbus_Response_UFC(Modbus_Response_Parents):
            ...
            match i:
                ...
                case 4:
                    return_datas.append({
                        "desc": port_types[j],
                        'value':
                            str(self.response_struct['data'][i])
                    }
                    )
                    j += 1
                    pass
    ...
    def parser_function_code_5(self):
        ...
        valve_desc=['鼠笼1气路','鼠笼1气路','鼠笼2气路','鼠笼3气路','鼠笼4气路','鼠笼5气路','鼠笼6气路','鼠笼7气路','鼠笼8气路','参考气气路','采样阀气路','气泵','UFC']
            ...
            match i:
                ...
                case 3:
                    match self.response_struct['data'][1]:
                        case 0:
                            value_desc = ""
                            data_list_bit_str = self.int_to_8bit_binary(num_list=self.response_struct['data'][i])
