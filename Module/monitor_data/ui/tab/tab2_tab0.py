...
class Ui_tab_0_frame(object):
    def setupUi(self, tab_0_frame):
        ...
        self.function_04 = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        self.function_04.setObjectName("function_04")
        self.function_04_layout.addWidget(self.function_04)
        self.tab_0_layout.addLayout(self.function_04_layout)
        ...
        self.function_01 = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        ...
        self.function_02 = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        ...
        self.function_03 = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        ...
        self.function_11 = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        ...
        self.tab_0_layout.addLayout(self.verticalLayout_4)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setContentsMargins(0, -1, -1, -1)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.start = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.start.setObjectName("start")
        self.horizontalLayout.addWidget(self.start)
        self.stop = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.stop.setObjectName("stop")
        self.horizontalLayout.addWidget(self.stop)
        self.refresh = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.refresh.setObjectName("refresh")
        self.horizontalLayout.addWidget(self.refresh)
        self.tab_0_layout.addLayout(self.horizontalLayout)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setContentsMargins(-1, 0, -1, -1)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.nowdata_trend_label = QtWidgets.QLabel(parent=self.verticalLayoutWidget_4)
        self.nowdata_trend_label.setObjectName("nowdata_trend_label")
        self.horizontalLayout_6.addWidget(self.nowdata_trend_label)
        self.export_alldata_btn = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        ...
        self.tab_0_layout.addLayout(self.verticalLayout_3)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.detaildata_groupbox = QtWidgets.QGroupBox(parent=self.verticalLayoutWidget_4)
        ...
        self.tab_0_layout.addLayout(self.verticalLayout)
