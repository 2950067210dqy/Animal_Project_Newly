# Form implementation generated from reading ui file 'tab2_tab0_window.ui'
#
...
class Ui_tab_0_window(object):
    def setupUi(self, tab_0_window):
        tab_0_window.setObjectName("tab_0_window")
        tab_0_window.resize(1083, 813)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(tab_0_window.sizePolicy().hasHeightForWidth())
        tab_0_window.setSizePolicy(sizePolicy)
        self.centralwidget = QtWidgets.QWidget(parent=tab_0_window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.detaildata_groupbox = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget)
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(parent=self.detaildata_groupbox)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 791, 461))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.detaildata_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        ...
        tab_0_window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=tab_0_window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1083, 22))
        self.menubar.setObjectName("menubar")
        tab_0_window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=tab_0_window)
        self.statusbar.setObjectName("statusbar")
        tab_0_window.setStatusBar(self.statusbar)

        self.retranslateUi(tab_0_window)
        QtCore.QMetaObject.connectSlotsByName(tab_0_window)

    def retranslateUi(self, tab_0_window):
        _translate = QtCore.QCoreApplication.translate
        tab_0_window.setWindowTitle(_translate("tab_0_window", "MainWindow"))
        self.start.setText(_translate("tab_0_window", "开始获取信息"))
        self.stop.setText(_translate("tab_0_window", "停止获取信息"))
        self.refresh.setText(_translate("tab_0_window", "刷新全部信息"))
        self.function_03.setTitle(_translate("tab_0_window", "传感器配置信息"))
        self.function_01.setTitle(_translate("tab_0_window", "输出端口状态信息"))
        self.function_02.setTitle(_translate("tab_0_window", "传感器状态信息"))
        self.function_11.setTitle(_translate("tab_0_window", "模块id信息"))
        self.function_04.setTitle(_translate("tab_0_window", "数据信息"))
        self.nowdata_trend_label.setText(_translate("tab_0_window", "当前趋势"))
        self.export_alldata_btn.setText(_translate("tab_0_window", "导出"))
        self.detaildata_groupbox.setTitle(_translate("tab_0_window", "详细数据"))
