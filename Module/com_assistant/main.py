...
class Main_com_assistant_service(BaseService):
    # 组件服务
    def __init__(self):
        pass
...
class Main_com_assistant_widget(BaseInterfaceWidget):
    # 组件自定义界面
    def __init__(self):
        super().__init__()
...
class Main_com_assistant(BaseModule):
    def __init__(self):
        super().__init__()
    ...
    def create_service(self) -> BaseService:
        """创建并返回组件的相关服务"""
        return Main_com_assistant_service()
        pass

    def get_interface_widget(self) -> BaseInterfaceWidget:
        """返回自定义界面构建器"""
        widget_builder =Main_com_assistant_widget()
