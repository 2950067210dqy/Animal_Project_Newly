...
from Module.com_assistant.ui.tab3_window import Ui_tab3_window
    ...
    def send_data(self):
        ...
        try:
            if self.validate_data():
                state = global_setting.get_setting("app_state")
